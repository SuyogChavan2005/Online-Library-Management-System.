...
<body style="width: 1519px; height: 690px;">
<?php
  $sql1 = mysqli_query($db, "SELECT student.pic, message.username 
                           FROM student 
                           INNER JOIN message ON student.username = message.username 
                           GROUP BY message.username 
                           ORDER BY student.status;");
  ...
  <div class="right_box2">
    ...
    /*--------------if submit is pressed-----------*/
      if(isset($_POST['submit']) && !empty($_POST['username']))
      {
        ...
        mysqli_query($db,"UPDATE message SET status='yes' where sender='student' and username='$_SESSION[username]';");
        ...
        <div class="msg">
          ...
          ?>
            ...
            <br><div class="chat user">
              <div style="float: left; padding-top: 5px;">
                &nbsp
                <img style="height: 40px; width: 40px; border-radius: 50%;" src="image/p.jpg">&nbsp
              </div>
          ...
          ?>
            ...
            <br><div class="chat admin">
              <div style="float: left; padding-top: 5px;">
                &nbsp
                <?php echo "<img class='img-circle profile_img' height=40 width=40 src='image/".$_SESSION['pic']."'>"; ?>
                &nbsp
              </div>
              <div style="float: left;" class="chatbox">
                <?php echo $row['message']; ?>
