...
<body>
	<section>
		<div class="reg_img">
			...
			<div class="box2">
				<h1 style="text-align: center; font-size: 35px; font-family: Lucida Consol;"> &nbsp Library Management System</h1>
      ...
      if(isset($_POST['submit']))
      {
        ...
        if($count==0)
        {
          ...
          $msg="Hello your OTP code is: ".$otp.".";
		      $from="From: enter-the-email-here"; /*Email id change here*/
